...
class TestHabit(APITestCase):
    ...
    def setUp(self):
        ...
        self.habit = Habit.objects.create(name='test', place='fas', time=datetime.datetime.now(), action_do='plak',
                                          time_do='100', is_public=True, award='fad', period_days=2, owner=self.user,
                                          pk=3)
        print(self.habit)
